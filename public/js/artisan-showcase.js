    ...
    overlay.innerHTML = `
        <div style="background:white;border-radius:1rem;padding:2rem;max-width:500px;width:100%;box-shadow:0 20px 40px rgba(0,0,0,0.2);">
            ...
            <div style="display:flex;gap:0.75rem;justify-content:flex-end;">
                ...
                <button onclick="sendMessage(${artisanId})" style="padding:0.75rem 1.5rem;border:none;border-radius:0.5rem;background:#ff6b35;color:white;font-weight:600;cursor:pointer;"><i class="fas fa-paper-plane"></i> Send</button>
            </div>
        </div>
    `;
